...
import { BContainer, BRow, BCol, BCard, BCardBody, BFormGroup, BForm, BFormInput, BFormSelect, BFormSelectOption, BButton } from 'bootstrap-vue'
                    ...
                    <b-card-body>
                        <b-form @submit.prevent="ingresar">
                            <b-form-group class="mb-2" label="Usuario:" label-for="usuario">
                                <b-form-input id="usuario" v-model.trim="form.usuario" type="text"
                                    placeholder="Ingrese su usuario" required></b-form-input>
                            </b-form-group>

                            <b-form-group class="mb-2" label="Rol:" label-for="rol">
                                <b-form-select id="rol" v-model.trim="form.rol" :options="roles" required>
                                    <template #first>
