...
<template>
    <b-container>
        <b-row class="mt-4">
            ...
            <b-col cols="12" md="4" xl="3" v-for="producto in productos" :key="producto.id">
                <b-card class="mb-4" :title="producto.nombre" :img-src="`imagenes/${producto.imagen}`"
                    :img-alt="producto.nombre" img-top>
                    <b-card-text>
